...
<xsl:template match="/atom:feed">
	...
	<script src="https://cdnjs.cloudflare.com/ajax/libs/d3/3.5.5/d3.min.js" async=""></script>
	<script src="https://cdn.rawgit.com/bmabey/pyLDAvis/files/ldavis.v1.0.0.js" async=""></script>
	<script src="https://cdn.rawgit.com/bmabey/pyLDAvis/files/ldavis.v1.0.0.js" async=""></script>
	...
	<meta property="og:site_name" content="Anatomy of Hashtags: Deconstructing Social Media Activism">
...
<div id="navigation" class="sticky">
  <nav class="top-bar" role="navigation" data-topbar>
    <ul class="title-area">
      <li class="name">
      <h1 class="show-for-small-only"><a href="http://localhost:4000" class="icon-tree"> Anatomy of Hashtags: Deconstructing Social Media Activism</a></h1>
    </li>
    ...
    <section class="top-bar-section">
      ...
      <ul class="left">
              ...
              <li><a  href="http://localhost:4000/black-lives-matter/">Black Lives Matter</a></li>
              <li class="divider"></li>
              ...
              <li><a  href="http://localhost:4000/trump/">Trump and Resist</a></li>
              <li class="divider"></li>
              ...
              <li><a  href="http://localhost:4000/misogyny/">Misogyny</a></li>
              <li class="divider"></li>
...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="/" title="Anatomy of Hashtags: Deconstructing Social Media Activism – TIME SERIES, NETWORK BASED, POLARITY, SUBJECTIVITY AND EVENT ANALYSIS OF HASHTAGS.">
				<img src="http://localhost:4000/assets/img/logo.png" alt="Anatomy of Hashtags: Deconstructing Social Media Activism – TIME SERIES, NETWORK BASED, POLARITY, SUBJECTIVITY AND EVENT ANALYSIS OF HASHTAGS.">
			</a>
      ...
      <div id="subfooter">
        <nav class="row">
          <section id="subfooter-left" class="small-12 medium-6 columns credits">
            <p>Created by Ada Pozo, Isabela Constantin and Keshav Singh </p> <p>Template from  <a href="http://phlow.de/">Phlow</a> with <a href="http://jekyllrb.com/" target="_blank">Jekyll</a></p>
          </section>

          <section id="subfooter-right" class="small-12 medium-6 columns">
            <ul class="inline-list social-icons">
            
              <li><a href="https://github.com/shaginhekvs/ada_course/tree/master/project" target="_blank" class="icon-github" title="Code"></a></li>
